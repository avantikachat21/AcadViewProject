from spy_details import spy, Spy_info, Chat_msg, myfriends
from termcolor import colored
from steganography.steganography import Steganography
from datetime import datetime

# avanti_app is here declared and if it is true it will run app else not run
...
while avanti_app:
    ...
    def send_msgs():
        ...
        new_image = "C:\Users\HP\PycharmProjects\spychat\img\output.jpeg"
    ...
    # here we are creating a chat function :- avanti_chat() in which all the cases and their validations are done
